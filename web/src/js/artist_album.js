...
function(utils, utilsTPL, call, prep) {
    ...
    function init (params){
        ...
        var al = utils.decodeHTMLEntities( params.album );

        call.artist_album( ar, al ).then(function(response) {
            console.log("Success!", response);

            //artist_album( response.data );
            ...
            console.log("Success!", response);
                ...
                artist_album( response );

            }, function(error) {
                console.error("0032 prep.albums Failed!", error);
            }); 
    ...
    function artist_album ( $data ){
        console.log("artist_album!", $data);
    ...
    function init____ ( artist, album ){
