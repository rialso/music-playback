...
exports.init = function(path) {
    ...
    //var path = '/Users/rialso/Music/______nevera/01\ I Want You.mp3';
...
var _getInformation = function( type, stdout ){
    return new Promise(function(resolve, reject) {
        ...
        if (type == 'audio'){
            ...
            //console.log('this is  @@@@@@ ----' +lyrics)
            //console.log('-------------------------lyrics xxxx-------------------------------- \n', lyrics[0])
...
var lyrics = function(metadata) {
    ...
    return new Promise(function(resolve, reject) {
        ...
        var lyricsFind   = /lyrics.*\s:/.exec(metadata) || []         //lyrics.*\s:\s(.+)\n\s(.+)\n\s(.+). lyrics.*\s:\s(.+)(\n.*){8}
      
        console.log('this is  @@@@@@ ----' +lyricsFind)

        var metadata_split = metadata.split(lyricsFind);



        //console.log(metadata_split[1])

        var lines = metadata_split[1].split('\n');
